...
public class SeleniumTest {
    ...
    public void findMobile() {
        ...
        driver.findElement(By.xpath("//div[contains(@class, 'n-w-tab__control-hamburger')]")).click();
        driver.findElement(By.xpath("//span[@class='n-w-tab__control-caption'][contains(text(),'Электроника')]")).click();
        //choose samrtphone
